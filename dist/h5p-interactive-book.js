...
(() => {
  var t = {
      ...
      6855: (t, e, r) => {
        ...
        for (var s in n) o.call(n, s) && (i[n[s]] = s);
        ...
        (c.get = function (t) {
          ...
          (c.get.rgb = function (t) {
            ...
            if ((e = t.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i))) {
              for (a = e[2], e = e[1], r = 0; r < 3; r++) {
                var s = 2 * r;
                i[r] = parseInt(e.slice(s, s + 2), 16);
              }
              a && (i[3] = parseInt(a, 16) / 255);
            } else if ((e = t.match(/^#([a-f0-9]{3,4})$/i))) {
              for (a = (e = e[1])[3], r = 0; r < 3; r++)
      ...
      7124: (t, e, r) => {
        const n = r(6855),
          ...
          o = ["keyword", "gray", "hex"],
          i = {};
        for (const t of Object.keys(a)) i[[...a[t].labels].sort().join("")] = t;
        const s = {};
        function c(t, e) {
          if (!(this instanceof c)) return new c(t, e);
          if ((e && e in o && (e = null), e && !(e in a)))
          ...
          if (null == t)
            ...
            (this.model = e.model),
              ...
              (this.color = e.value.slice(0, u)),
              (this.valpha = "number" == typeof e.value[u] ? e.value[u] : 1);
          } else if (t.length > 0) {
            (this.model = e || "rgb"), (u = a[this.model].channels);
            const r = Array.prototype.slice.call(t, 0, u);
            (this.color = h(r, u)),
              (this.valpha = "number" == typeof t[u] ? t[u] : 1);
            ...
            this.model = i[n];
            const { labels: o } = a[this.model],
              s = [];
            for (r = 0; r < o.length; r++) s.push(t[o[r]]);
            this.color = h(s);
          }
          if (s[this.model])
            for (u = a[this.model].channels, r = 0; r < u; r++) {
              const t = s[this.model][r];
        ...
        c.prototype = {
          ...
          object() {
            const t = {},
              { channels: e } = a[this.model],
              { labels: r } = a[this.model];
          ...
          round(t) {
            return (
              (t = Math.max(t || 0, 0)),
              new c([...this.color.map(u(t)), this.valpha], this.model)
            );
          },
          alpha(t) {
            return void 0 !== t
              ? new c([...this.color, Math.max(0, Math.min(1, t))], this.model)
              : this.valpha;
          },
          red: l("rgb", 0, p(255)),
          green: l("rgb", 1, p(255)),
          ...
          saturationl: l("hsl", 1, p(100)),
          lightness: l("hsl", 2, p(100)),
          saturationv: l("hsv", 1, p(100)),
          value: l("hsv", 2, p(100)),
          chroma: l("hcg", 1, p(100)),
          gray: l("hcg", 2, p(100)),
          white: l("hwb", 1, p(100)),
          wblack: l("hwb", 2, p(100)),
          cyan: l("cmyk", 0, p(100)),
          magenta: l("cmyk", 1, p(100)),
          yellow: l("cmyk", 2, p(100)),
          black: l("cmyk", 3, p(100)),
          x: l("xyz", 0, p(95.047)),
          y: l("xyz", 1, p(100)),
          z: l("xyz", 2, p(108.833)),
          l: l("lab", 0, p(100)),
          ...
          b: l("lab", 2),
          keyword(t) {
            return void 0 !== t ? new c(t) : a[this.model].keyword(this.color);
          },
          hex(t) {
            return void 0 !== t ? new c(t) : n.to.hex(this.rgb().round().color);
          },
          hexa(t) {
            if (void 0 !== t) return new c(t);
        ...
        for (const t of Object.keys(a)) {
          ...
          (c.prototype[t] = function (...e) {
            return this.model === t
              ...
              : new c(
                  [
                    ...((r = a[this.model][t].raw(this.color)),
                    Array.isArray(r) ? r : [r]),
                    this.valpha,
                  ],
                  t
            ...
            (c[t] = function (...r) {
              let n = r[0];
              return "number" == typeof n && (n = h(r, e)), new c(n, t);
            });
        }
        function u(t) {
          return function (e) {
        ...
        function l(t, e, r) {
          ...
          for (const n of t) (s[n] || (s[n] = []))[e] = r;
          return (
            (t = t[0]),
            function (n) {
              let a;
              return void 0 !== n
                ? (r && (n = r(n)), (a = this[t]()), (a.color[e] = n), a)
                : ((a = this[t]().color[e]), r && (a = r(a)), a);
            }
          );
        }
        function p(t) {
      ...
      5043: (t, e, r) => {
        const n = r(1086),
          a = {};
        for (const t of Object.keys(n)) a[n[t]] = t;
        const o = {
        ...
        for (const t of Object.keys(o)) {
          ...
          if (o[t].labels.length !== o[t].channels)
            throw new Error("channel and label counts mismatch: " + t);
          const { channels: e, labels: r } = o[t];
          delete o[t].channels,
            delete o[t].labels,
            Object.defineProperty(o[t], "channels", { value: e }),
            Object.defineProperty(o[t], "labels", { value: r });
        }
        (o.rgb.hsl = function (t) {
          ...
          (o.rgb.lab = function (t) {
            ...
            return [116 * n - 16, 500 * (r - n), 200 * (n - a)];
          }),
          ...
          (o.xyz.rgb = function (t) {
            ...
            let a, o, i;
            return (
              (a = 3.2406 * e + -1.5372 * r + -0.4986 * n),
              (o = -0.9689 * e + 1.8758 * r + 0.0415 * n),
              (i = 0.0557 * e + -0.204 * r + 1.057 * n),
          ...
          (o.lab.lch = function (t) {
            const e = t[0],
              ...
              n = t[2];
            let a;
            (a = (360 * Math.atan2(n, r)) / 2 / Math.PI), a < 0 && (a += 360);
            return [e, Math.sqrt(r * r + n * n), a];
          }),
          ...
          (o.hsl.hcg = function (t) {
            ...
            let a = 0;
            return (
              n < 1 && (a = (r - 0.5 * n) / (1 - n)), [t[0], 100 * n, 100 * a]
            );
          }),
          ...
          (o.hcg.rgb = function (t) {
            ...
            return (
              (c = (1 - r) * n),
              [255 * (r * a[0] + c), 255 * (r * a[1] + c), 255 * (r * a[2] + c)]
            );
          }),
      ...
      8074: (t, e, r) => {
        ...
        function i(t, e) {
          ...
          let a = n[e[t].parent][t],
            i = e[t].parent;
          for (; e[i].parent; )
            r.unshift(e[i].parent),
              (a = o(n[e[i].parent][i], a)),
              (i = e[i].parent);
        ...
        t.exports = function (t) {
          const e = a(t),
            r = {},
            n = Object.keys(e);
          for (let t = n.length, a = 0; a < t; a++) {
            const t = n[a];
            null !== e[t].parent && (r[t] = i(t, e));
          }
          return r;
        };
      },
      ...
      1842: (t, e, r) => {
        ...
        t.exports = function (t) {
          var e = o(t),
            ...
            m = void 0 !== v;
          m && (v = n(v, f > 2 ? arguments[2] : void 0));
          var b,
            g,
            y,
            k,
            ...
            x = 0;
          if (!S || (this === d && s(S)))
            for (b = u(e), g = r ? new this(b) : d(b); b > x; x++)
              (C = m ? v(e[x], x) : e[x]), l(g, x, C);
          else
            for (
              w = (k = p(e, S)).next, g = r ? new this() : [];
              !(y = a(w, k)).done;
              x++
            )
              (C = m ? i(k, v, [y.value, x], !0) : y.value), l(g, x, C);
          return (g.length = x), g;
        };
      },
      6198: (t, e, r) => {
            ...
            return function (f, v, m, b) {
              for (
                var g,
                  ...
                  x = 0,
                  O = b || c,
                  E = e ? O(f, S) : r || h ? O(f, 0) : void 0;
                S > x;
                x++
              )
                if ((d || x in w) && ((y = C((g = w[x]), x, k)), t))
                  if (e) E[x] = y;
                  else if (y)
                    switch (t) {
                      case 3:
      ...
      8474: (t, e, r) => {
        var n = r(9606),
          ...
          i = r(7826);
        t.exports = function (t, e, r) {
          for (var s = a(e), c = i.f, u = o.f, l = 0; l < s.length; l++) {
            var p = s[l];
      ...
      1343: (t, e, r) => {
        ...
        t.exports = function (t, e, r, s) {
          ...
          if ((n(r) && o(r, u, s), s.global)) c ? (t[e] = r) : i(e, r);
          else {
            try {
      ...
      9444: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          try {
            a(n, t, { value: e, configurable: !0, writable: !0 });
          } catch (r) {
            n[t] = e;
          }
          return e;
      ...
      8432: (t, e, r) => {
        ...
        t.exports = function (t, e, r, i, f, m, E) {
          c(r, e, i);
          var L,
            P,
            A,
            ...
            I = !1,
            M = t.prototype,
            B = M[w] || M["@@iterator"] || (f && M[f]),
            F = (!k && B) || T(f),
            R = ("Array" == e && M.entries) || B;
          if (
            (R &&
              (L = u(R.call(new t()))) !== Object.prototype &&
              L.next &&
              (o || u(L) === y || (l ? l(L, y) : s(L[w]) || d(L, w, O)),
              p(L, j, !0, !0),
              o && (v[j] = O)),
            b &&
              f == S &&
            ...
            if (((P = { values: T(S), keys: m ? F : T(C), entries: T(x) }), E))
              for (A in P) (k || I || !(A in M)) && d(M, A, P[A]);
            else n({ target: e, proto: !0, forced: k || I }, P);
          return (
            (o && !E) || M[w] === F || d(M, w, F, { name: f }), (v[e] = F), P
          );
        };
      },
      4145: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          ...
          if ((r = v ? n : m ? n[f] || s(f, {}) : (n[f] || {}).prototype))
            for (l in e) {
              if (
                ((h = e[l]),
                (p = t.dontCallGetSet ? (d = a(r, l)) && d.value : r[l]),
                !u(v ? l : f + (m ? "." : "#") + l, t.forced) && void 0 !== p)
              ) {
                if (typeof h == typeof p) continue;
                c(h, p);
              }
              (t.sham || (p && p.sham)) && o(h, "sham", !0), i(r, l, h, t);
            }
        };
      },
      3677: (t) => {
      ...
      2331: (t, e, r) => {
        ...
        t.exports = function (t, e, r, p) {
          ...
          if (!d || !f || r) {
            var v = n(/./[h]),
              m = e(h, ""[t], function (t, e, r, a, i) {
                var s = n(t),
                  c = e.exec;
                return c === o || c === l.exec
                  ? d && !i
                    ? { done: !0, value: v(e, r, a) }
                    : { done: !0, value: s(r, e, a) }
                  : { done: !1 };
              });
            a(String.prototype, t, m[0]), a(l, h, m[1]);
          }
          p && c(l[h], "sham", !0);
        };
      },
      ...
      1667: (t, e, r) => {
        var n = r(375),
          ...
          i = r(211)("iterator");
        t.exports = function (t) {
          if (null != t) return a(t, i) || a(t, "@@iterator") || o[n(t)];
        };
      },
      3546: (t, e, r) => {
        var n = r(9413),
      ...
      8509: (t, e, r) => {
        var n = r(8240),
          ...
          u = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
          l = /\$([$&'`]|\d{1,2})/g;
        t.exports = function (t, e, r, n, p, h) {
          var d = r + t.length,
            f = n.length,
            v = l;
          return (
          ...
          g = (t.exports = {
            enable: function () {
              ...
              (r[v] = 1),
                t(r).length &&
                  ((u.f = function (r) {
                    for (var n = t(r), a = 0, o = n.length; a < o; a++)
                      if (n[a] === v) {
                        e(n, a, 1);
                        break;
                      }
      ...
      3278: (t, e, r) => {
        var n,
          ...
          b = s.WeakMap;
        if (i || h.state) {
          var g = h.state || (h.state = new b()),
            y = c(g.get),
            k = c(g.has),
            w = c(g.set);
          (n = function (t, e) {
            if (k(g, t)) throw new m(v);
      ...
      2814: (t, e, r) => {
        var n = r(211),
          ...
          i = Array.prototype;
        t.exports = function (t) {
          return void 0 !== t && (a.Array === t || i[o] === t);
        };
      },
      6526: (t, e, r) => {
        var n = r(2306);
      ...
      7994: (t, e, r) => {
        ...
        t.exports = function (t) {
          var e;
          return n(t) && (void 0 !== (e = t[o]) ? !!e : "RegExp" == a(t));
        };
      },
      2071: (t, e, r) => {
        var n = r(563),
      ...
      9316: (t, e, r) => {
        var n = r(2086),
          ...
          o = r(9277),
          i = n.WeakMap;
        t.exports = a(i) && /native code/.test(o(i));
      },
      8675: (t, e, r) => {
        "use strict";
        var n = r(5283),
        ...
        t.exports =
          ...
          i(function () {
            ...
            return (
              ...
              7 != h({}, t)[r] || s(h({}, e)).join("") != a
            );
          })
            ? function (t, e) {
                for (
                  var r = l(t), a = arguments.length, i = 1, h = c.f, d = u.f;
                  a > i;
              ...
              "undefined" != typeof document
                ? document.domain && n
                  ...
                  : ((e = u("iframe")),
                    ...
                    t.F)
                : m(n);
            for (var a = i.length; a--; ) delete b[p][i[a]];
            return b();
          };
        (s[d] = !0),
          (t.exports =
            ...
            function (t, e) {
              ...
              return (
                null !== t
                  ? ((f[p] = a(t)), (r = new f()), (f[p] = null), (r[d] = t))
                  : (r = b()),
                void 0 === e ? r : o.f(r, e)
              );
            });
      ...
      7711: (t, e, r) => {
        ...
        e.f =
          n && !a
            ...
            : function (t, e) {
                i(t);
                for (var r, n = s(e), a = c(e), u = a.length, l = 0; u > l; )
                  o.f(t, (r = a[l++]), n[r]);
                return t;
              };
      },
      ...
      4399: (t, e, r) => {
        ...
        e.f = n
          ...
          : function (t, e) {
              ...
              if (u(t, e)) return i(!a(o.f, t, e), t[e]);
            };
      },
      3226: (t, e, r) => {
        var n = r(2306),
      ...
      62: (t, e, r) => {
        var n = r(1352),
          a = r(8684).concat("length", "prototype");
        e.f =
      ...
      3813: (t, e, r) => {
        ...
        t.exports =
          c || i
            ? function (t) {
                return !!a(t) && (!i || "ArrayBuffer" != o(t)) && (!s || s(t));
              }
            : s;
      },
      5516: (t, e, r) => {
      ...
      1352: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          ...
          for (; e.length > u; ) a(n, (r = e[u++])) && (~i(l, r) || c(l, r));
          return l;
        };
      },
      8779: (t, e, r) => {
        ...
        t.exports =
          ...
          ("__proto__" in {}
            ? (function () {
                ...
                return function (r, n) {
                  return a(r), o(n), e ? t(r, n) : (r.__proto__ = n), r;
                };
              })()
            : void 0);
      },
      ...
      7999: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          var r, s;
          if ("string" === e && a((r = t.toString)) && !o((s = n(r, t))))
            return s;
          if (a((r = t.valueOf)) && !o((s = n(r, t)))) return s;
          if ("string" !== e && a((r = t.toString)) && !o((s = n(r, t))))
            return s;
          ...
          (b = function (t) {
            ...
            if (
              ...
              P
                ...
                : C &&
                  a &&
                  (d.lastIndex = d.global ? a.index + a[0].length : n),
              x &&
                a &&
                a.length > 1 &&
                o(v, a[0], r, function () {
              ...
              for (a.groups = u = p(null), i = 0; i < L.length; i++)
                u[(l = L[i])[0]] = a[l[1]];
            return a;
          }),
          (t.exports = b);
      ...
      9028: (t, e, r) => {
        ...
        t.exports = function (t) {
          var e = t.flags;
          return void 0 !== e || "flags" in s || a(t, "flags") || !o(s, t)
            ? e
            : n(i, t);
        };
      },
      4930: (t, e, r) => {
        ...
        t.exports = { BROKEN_CARET: s, MISSED_STICKY: i, UNSUPPORTED_Y: o };
      },
      2582: (t, e, r) => {
        var n = r(3677),
          a = r(2086).RegExp;
      ...
      914: (t, e, r) => {
        ...
        t.exports = function (t, e, r) {
          t && !r && (t = t.prototype),
            t && !a(t, o) && n(t, o, { configurable: !0, value: e });
        };
      },
      8944: (t, e, r) => {
        var n = r(9197),
      ...
      8515: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          var r,
            i = n(t).constructor;
          return void 0 === i || null == (r = n(i)[o]) ? e : a(r);
        };
      },
      3448: (t, e, r) => {
        var n = r(8240),
      ...
      1288: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          ...
          if (c) {
            if (
              (void 0 === e && (e = "default"), (r = n(c, t, e)), !a(r) || o(r))
            )
              return r;
      ...
      5422: (t, e, r) => {
        var n = r(8240),
          ...
          i = n((1).toString);
        t.exports = function (t) {
          return "Symbol(" + (void 0 === t ? "" : t) + ")_" + i(++a + o, 36);
        };
      },
      1876: (t, e, r) => {
        var n = r(3193);
      ...
      211: (t, e, r) => {
        var n = r(2086),
          ...
          l = n.Symbol,
          p = l && l.for,
          h = c ? l : (l && l.withoutSetter) || i;
        t.exports = function (t) {
          if (!o(u, t) || (!s && "string" != typeof u[t])) {
            var e = "Symbol." + t;
            s && o(l, t) ? (u[t] = l[t]) : (u[t] = c && p ? p(e) : h(e));
          }
          return u[t];
        };
      },
      3938: (t, e, r) => {
        ...
        n(
          { target: "Array", proto: !0, arity: 1, forced: !m || !b },
          {
            concat: function (t) {
              var e,
                r,
              ...
              for (e = -1, n = arguments.length; e < n; e++)
                if (g((o = -1 === e ? i : arguments[e])))
                  for (a = c(o), u(d + a), r = 0; r < a; r++, d++)
                    r in o && l(h, d, o[r]);
                else u(d + 1), l(h, d++, o);
              return (h.length = d), h;
            },
      ...
      5769: (t, e, r) => {
        ...
        if (
          (a("keys"), a("values"), a("entries"), !u && l && "values" !== f.name)
        )
          try {
          ...
          { target: "Array", proto: !0, forced: !f },
          {
            slice: function (t, e) {
              ...
              if (
                ...
                return d(h, g, y);
              for (
                n = new (void 0 === r ? m : r)(b(y - g, 0)), p = 0;
                g < y;
                g++, p++
              )
                g in h && l(n, p, h[g]);
      ...
      5735: (t, e, r) => {
        var n = r(1695),
          ...
          E = function (t, e) {
            ...
            if ((p(e) || void 0 !== t) && !h(t))
              return (
                u(e) ||
                  (e = function (t, e) {
                    if ((l(n) && (e = i(n, this, t, e)), !h(e))) return e;
                  }),
                (r[1] = e),
                o(v, null, r)
              );
          ...
          L = function (t, e, r) {
            var n = b(r, e - 1),
              a = b(r, e + 1);
            return (m(C, t) && !m(S, a)) || (m(S, t) && !m(C, n))
              ? "\\u" + k(g(t, 0), 16)
              : t;
          };
        v &&
          n(
            { target: "JSON", stat: !0, arity: 3, forced: x || O },
            {
              stringify: function (t, e, r) {
                var n = d(arguments),
                  a = o(x ? E : v, null, n);
                return O && "string" == typeof a ? y(a, w, L) : a;
              },
            }
          );
      },
        ...
        n(
          { target: "Object", stat: !0, sham: !a },
          {
            getOwnPropertyDescriptors: function (t) {
              for (
                var e, r, n = i(t), a = s.f, u = o(n), l = {}, p = 0;
                u.length > p;

              )
                void 0 !== (r = a(n, (e = u[p++]))) && c(l, e, r);
              return l;
            },
          }
        );
      ...
      7460: (t, e, r) => {
        ...
        i(
          ...
          "String",
          function (t) {
            c(this, { type: s, string: a(t), index: 0 });
          },
          function () {
            var t,
              e = u(this),
            ...
            return a >= r.length
              ? { value: void 0, done: !0 }
              : ((t = n(r, a)), (e.index += t.length), { value: t, done: !1 });
          }
        );
      },
      911: (t, e, r) => {
        ...
        i(
          ...
          function (t, e, r) {
            ...
            return [
              function (t, r) {
                var n = d(this),
                  o = null == t ? void 0 : v(t, g);
                return o ? a(o, t, n, r) : a(e, h(n), t, r);
              },
              function (t, a) {
                var i = c(this),
                  s = h(t);
                ...
                for (var E = []; ; ) {
                  ...
                  if (null === L) break;
                  if ((C(E, L), !g)) break;
                  "" === h(L[0]) && (i.lastIndex = f(s, p(i.lastIndex), O));
                }
                for (var P, A = "", T = 0, j = 0; j < E.length; j++) {
                  for (
                    var I = h((L = E[j])[0]),
                      M = y(k(l(L.index), s.length), 0),
                      B = [],
                      F = 1;
                    F < L.length;
                    F++
                  )
                    C(B, void 0 === (P = L[F]) ? P : String(P));
                  var R = L.groups;
                  if (v) {
                    var N = w([I], B, M, s);
                    void 0 !== R && C(N, R);
                    var D = h(n(a, void 0, N));
                  } else D = m(I, s, M, B, R, a);
                  M >= T && ((A += x(s, T, M) + D), (T = M + I.length));
                }
                return A + x(s, T);
              },
            ];
            ...
            return (
              (o =
                ...
                "".split(/.?/).length
                  ...
                  ? function (t, r) {
                      return void 0 === t && 0 === r ? [] : a(e, this, t, r);
                    }
                  : e),
              [
                function (e, r) {
                  ...
                  return i ? a(i, e, n, r) : a(o, d(n), e, r);
                },
                function (t, n) {
                  var a = c(this),
                    i = d(t),
                  ...
                  var u = l(a, RegExp),
                    ...
                    v =
                      ...
                      (a.unicode ? "u" : "") +
                      (k ? "g" : "y"),
                    b = new u(k ? "^(?:" + a.source + ")" : a, v),
                    g = void 0 === n ? w : n >>> 0;
                  if (0 === g) return [];
                  if (0 === i.length) return null === m(b, i) ? [i] : [];
                  for (var y = 0, S = 0, x = []; S < i.length; ) {
                    b.lastIndex = k ? 0 : S;
                    var L,
                      P = m(b, k ? E(i, S) : i);
                    if (
                      null === P ||
                      (L = C(h(b.lastIndex + (k ? S : 0)), i.length)) === y
                    )
                      S = p(i, S, f);
                    else {
                      if ((O(x, E(i, y, S)), x.length === g)) return x;
                      for (var A = 1; A <= P.length - 1; A++)
                        if ((O(x, P[A]), x.length === g)) return x;
                      S = y = L;
                    }
                  }
                  return O(x, E(i, y)), x;
      ...
      4211: (t, e, r) => {
        ...
        var n = r(1695),
          ...
          ot = function (t, e) {
            var r = (tt[t] = g($));
            return (
              q(r, { type: _, tag: t, description: e }),
              c || (r.description = e),
              r
            );
          },
          ...
          ct = function (t) {
            var e = v(t),
              r = o(Q, this, e);
            return (
              !(this === W && p(tt, e) && !p(et, e)) &&
              (!(r || !p(this, e) || !p(tt, e) || (p(this, H) && this[H][e])) ||
                r)
            );
          },
          ut = function (t, e) {
            var r = f(t),
              n = v(e);
            if (r !== W || !p(tt, n) || p(et, n)) {
              var a = J(r, n);
              return (
                !a || !p(tt, n) || (p(r, H) && r[H][n]) || (a.enumerable = !0),
                a
              );
            }
          },
        ...
        u ||
          (L(
            ($ = (V = function () {
              if (h($, this)) throw G("Symbol is not a constructor");
              var t =
              ...
              return (
                c && nt && at(W, e, { configurable: !0, set: r }), ot(e, t)
              );
            })[z]),
            "toString",
            function () {
          ...
          c &&
            ...
            s || L(W, "propertyIsEnumerable", ct, { unsafe: !0 }))),
          n(
            ...
            m = function () {
              var t =
                  arguments.length < 1 || void 0 === arguments[0]
                    ? void 0
                    : l(arguments[0]),
                e = u(f, this) ? new d(t) : void 0 === t ? d() : d(t);
              return "" === t && (v[e] = !0), e;
            };
          h(m, d), (m.prototype = f), (f.constructor = m);
      ...
      9819: (t, e, r) => {
        ...
        n(
          ...
          {
            keyFor: function (t) {
              if (!o(t)) throw TypeError(i(t) + " is not a symbol");
              if (a(u, t)) return u[t];
            },
          }
        );
      ...
      4078: (t, e, r) => {
        ...
        for (var d in a) h(n[d] && n[d].prototype, d);
        h(o, "DOMTokenList");
      },
      2062: () => {
        var t;
          ...
          Element.prototype.scroll ||
            (Element.prototype.scroll = function () {
              var e,
                ...
                o = a.defaultView,
                i = "BackCompat" == a.compatMode,
                s = document.getElementsByTagName("BODY")[0],
                c = {};
              if (a == window.document && o && 0 !== n) {
                if (1 === n) {
                  var u = arguments[0];
                  if ("object" != typeof u)
                    throw "Failed to execute 'scrollBy' on 'Element': parameter 1 ('options') is not an object.";
                  "left" in u && (c.left = t(u.left)),
                    "top" in u && (c.top = t(u.top)),
                    (e = "left" in c ? c.left : this.scrollLeft),
                    (r = "top" in c ? c.top : this.scrollTop);
                } else
                  (c.left = e = t(arguments[0])), (c.top = r = t(arguments[1]));
                if (this != document.documentElement)
                  ...
                  (function (t) {
                    ...
                    var e = window.getComputedStyle(t),
                      ...
                      i = r.overflowY;
                    return (
                      ("table-column" == e.display ||
                        "table-column-group" == e.display) &&
                      "visible" != o &&
                      "clip" != o &&
                      "visible" != i &&
                      "clip" != i &&
            ...
            (Element.prototype.scrollBy = function () {
              ...
              if (0 !== e) {
                if (1 === e) {
                  ...
                  if ("object" != typeof n)
                    throw "Failed to execute 'scrollBy' on 'Element': parameter 1 ('options') is not an object.";
                  "left" in n && (r.left = t(n.left)),
                    "top" in n && (r.top = t(n.top));
                } else (r.left = t(arguments[0])), (r.top = t(arguments[1]));
                (r.left =
                  "left" in r ? r.left + this.scrollLeft : this.scrollLeft),
                  (r.top =
                    "top" in r ? r.top + this.scrollTop : this.scrollTop),
                  this.scroll(r);
              }
            });
      },
                ...
                (e.prototype = {
                  ...
                  initFill: function () {
                    ...
                    if (
                      ...
                      var i = n.gradient;
                      if (1 == i.length) this.arcFill = i[0];
                      else if (i.length > 1) {
                        for (
                          var s = n.gradientAngle || 0,
                            ...
                            u = a.createLinearGradient.apply(a, c),
                            l = 0;
                          l < i.length;
                          l++
                        ) {
                    ...
                    function d() {
                      ...
                      (n.width = r.size),
                        ...
                        (r.arcFill = r.ctx.createPattern(n, "no-repeat")),
                        r.drawFrame(r.lastFrameValue);
                    }
                    n.image &&
                      (n.image instanceof Image
                        ? (e = n.image)
                        : ((e = new Image()).src = n.image),
                      e.complete ? d() : (e.onload = d));
                  },
                  draw: function () {
                    this.animation
                  ...
                  drawArc: function (t) {
                    if (0 !== t) {
                      ...
                      e.save(),
                        e.beginPath(),
                        this.reverse
                          ? e.arc(r, r, r - n / 2, a - 2 * Math.PI * t, a)
                          : e.arc(r, r, r - n / 2, a, a + 2 * Math.PI * t),
                        (e.lineWidth = n),
                      ...
                      a
                        ...
                        .animate(
                          ...
                          t.extend({}, this.animation, {
                            step: function (t) {
                              var a = r.animationStartValue * (1 - t) + e * t;
                              r.drawFrame(a),
                                n.trigger("circle-animation-progress", [t, a]);
                            },
                          })
                        )
                        .promise()
                  ...
                  getThickness: function () {
                    return t.isNumeric(this.thickness)
                      ? this.thickness
                      : this.size / 14;
                  },
                  getValue: function () {
                  ...
                  (t.fn.circleProgress = function (r, n) {
                    ...
                    if ("value" == r) {
                      ...
                      return this.each(function () {
                        t(this).data(a).setValue(i);
                      });
                    }
                    return this.each(function () {
                      var n = t(this),
                        o = n.data(a),
                        i = t.isPlainObject(r) ? r : {};
                      if (o) o.init(i);
                      else {
                        var s = t.extend({}, n.data());
                        "string" == typeof s.fill &&
                          (s.fill = JSON.parse(s.fill)),
        ...
        var n = r(7190),
          ...
          i = (t.exports = function (t) {
            for (var e = [], r = 0, i = t.length; r < i; r++) {
              var s = t[r];
              n(s) ? (e = a.call(e, o.call(s))) : e.push(s);
            }
            return e;
          });
        i.wrap = function (t) {
  ...
  (r.n = (t) => {
    ...
    (() => {
      ...
      const l = (function (t) {
        ...
        function u(t, e, r, n) {
          ...
          return (
            ...
            (a.content = document.createElement("ul")),
            a.content.classList.add("navigation-list"),
            (a.container = a.addSideBar()),
            (a.l10n = t.l10n),
            (a.chapters = a.findAllChapters(t.chapters)),
            (a.chapterNodes = a.getChapterNodes()),
            r &&
              ((a.titleElem = a.addMainTitle(r)),
              a.container.appendChild(a.titleElem)),
            a.chapterNodes.forEach(function (t) {
              a.content.appendChild(t);
            }),
            a.chapters.length > 20 &&
              a.content.classList.add("large-navigation-list"),
            a.container.appendChild(a.content),
            a.addTransformListener(),
            a.initializeNavigationControls(),
            a
          );
        }
        return (
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (r < 0
                    ? (r = this.chapterNodes.length - 1)
                    : r > this.chapterNodes.length - 1 && (r = 0),
                  e)
                ) {
                  var n = e > 0 ? t : r,
                    a = this.chapterNodes[n];
                  if (
                    ...
                    if (o.length) {
                      var i = e > 0 ? 0 : o.length - 1;
                      return void this.setFocusToSectionItem(n, i);
                    }
                  }
                }
                var s = this.chapterNodes[r].querySelector(
                  ".h5p-interactive-book-navigation-chapter-button"
                );
                this.setFocusToItem(s, r);
              },
            },
            {
              ...
              value: function (t, e) {
                var r =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ? arguments[2]
                      : 0,
                  n = this.chapterNodes[t].querySelectorAll(
                    ".h5p-interactive-book-navigation-section"
                  ),
                  a = e + r;
                if (a > n.length - 1) this.setFocusToChapterItem(t + 1);
                else if (a < 0) this.setFocusToChapterItem(t);
                else {
                  var o = n[a].querySelector(".section-button");
                  this.setFocusToItem(o, t);
                }
              },
            },
            {
              ...
              value: function (t, e) {
                ...
                this.chapterNodes.forEach(function (t, r) {
                  ...
                  r === e
                    ? n.classList.add("h5p-interactive-book-navigation-current")
                    : n.classList.remove(
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  (t.id = "h5p-interactive-book-navigation-menu"),
                  t.classList.add("h5p-interactive-book-navigation"),
                  t
                );
              },
            },
            {
              ...
              value: function (t) {
                ...
                e.classList.add("navigation-title"),
                  (e.innerHTML = t),
                  e.setAttribute("title", t);
                var r = document.createElement("div");
                return (
                  r.classList.add("h5p-interactive-book-navigation-maintitle"),
                  r.appendChild(e),
                  r
                );
              },
                ...
                for (
                  ...
                  (o =
                    ...
                    e.push({
                      title: o,
                      id: a.subContentId
                        ? "h5p-interactive-book-section-".concat(a.subContentId)
                        : void 0,
                    });
                }
                return e;
              ...
              value: function (t) {
                for (var e = [], r = 0; r < t.length; r++) {
                  var n = this.findSectionsInChapter(t[r]),
                    a = t[r].metadata.title,
                    o = "h5p-interactive-book-chapter-".concat(
                      t[r].subContentId
                    );
                  e.push({ sections: n, title: a, id: o, isSummary: !1 });
                }
                return (
            ...
            },
            {
              ...
              value: function () {
                ...
                this.chapterNodes.forEach(function (e, r) {
                  ...
                  try {
                    for (o.s(); !(n = o.n()).done; ) {
                      var i = n.value.querySelector(
                        ".h5p-interactive-book-navigation-section-icon"
                      );
                      i &&
                        (i.classList.remove("icon-question-answered"),
                        i.classList.add("icon-chapter-blank"));
                    }
                  } catch (t) {
                    o.e(t);
                  } finally {
            ...
            },
            {
              ...
              value: function (t, e) {
                if (
                  ...
                  !this.chapters[t].isSummary
                ) {
                  var r = this.chapterNodes[t].getElementsByClassName(
                    "h5p-interactive-book-navigation-chapter-progress"
                  )[0];
                  "BLANK" === e
                    ? (r.classList.remove("icon-chapter-started"),
                      r.classList.remove("icon-chapter-done"),
                      r.classList.add("icon-chapter-blank"))
                    : "DONE" === e
                    ? (r.classList.remove("icon-chapter-blank"),
                      r.classList.remove("icon-chapter-started"),
                      r.classList.add("icon-chapter-done"))
                    : "STARTED" === e &&
                      (r.classList.remove("icon-chapter-blank"),
                      r.classList.remove("icon-chapter-done"),
                      r.classList.add("icon-chapter-started"));
                }
              },
            },
            {
              ...
              value: function (t, e) {
                ...
                r &&
                  (r.classList.remove("icon-chapter-blank"),
                  r.classList.add("icon-question-answered"));
              },
            },
            {
              ...
              value: function (t, e) {
                var r = this,
                  ...
                  a = "h5p-interactive-book-sectionlist-" + e;
                if (
                  (n.classList.add("h5p-interactive-book-navigation-chapter"),
                  t.isSummary)
                ) {
                  n.classList.add(
                    "h5p-interactive-book-navigation-summary-button"
                  );
                  var o = this.parent.chapters[e].instance.summaryMenuButton;
                  return (
                    o.classList.add(
                      "h5p-interactive-book-navigation-chapter-button"
                    ),
                ...
                u.setAttribute("tabindex", 0 === e ? "0" : "-1"),
                  u.classList.add(
                    "h5p-interactive-book-navigation-chapter-button"
                  ),
                  this.parent.activeChapter !== e
                    ? (i.classList.add("icon-collapsed"),
                      u.setAttribute("aria-expanded", "false"))
                    : (i.classList.add("icon-expanded"),
                      u.setAttribute("aria-expanded", "true")),
                  u.setAttribute("aria-controls", a),
                  (u.onclick = function (t) {
                    var n = !t.currentTarget
                      ...
                      a =
                        "true" ===
                        t.currentTarget.getAttribute("aria-expanded");
                    if (
                      (r.isOpenOnMobile() && r.parent.trigger("toggleMenu"),
                      r.isOpenOnMobile() || !n || !a)
                    ) {
                      var o = {
                        h5pbookid: r.parent.contentId,
                        chapter: r.chapters[e].id,
                        section: 0,
                      };
                ...
                for (
                  var p = [], h = 0;
                  h < this.chapters[e].sections.length;
                  h++
                )
                  if (this.parent.chapters[e].sections[h].isTask) {
                    var d = this.createSectionLink(e, h);
                    p.push(d), l.appendChild(d);
                  } else {
                    var f =
                ...
                if (
                  (t.tasksLeft && (t.maxTasks = t.tasksLeft), 0 === p.length)
                ) {
                  var k = n.querySelector(
                    ".h5p-interactive-book-navigation-chapter-accordion"
                  );
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                (i.innerHTML = n || o.title),
                  i.setAttribute("title", n || o.title),
                  i.classList.add(
                ...
                s.classList.add("h5p-interactive-book-navigation-section-icon"),
                  ...
                  this.parent.chapters[t].sections[e].isTask &&
                    s.classList.add(
                ...
                c.classList.add("section-button"),
                  ...
                  (c.onclick = function (e) {
                    var n = {
                      h5pbookid: r.parent.contentId,
                      chapter: r.chapters[t].id,
                      section: o.id,
                    };
                    null !== a && (n.headerNumber = a),
                      r.parent.trigger("newChapter", n),
                      r.isOpenOnMobile() && r.parent.trigger("toggleMenu"),
                      e.preventDefault();
                  }),
                  c.appendChild(s),
                ...
                return (
                  u.classList.add("h5p-interactive-book-navigation-section"),
                  u.classList.add(
                    "h5p-interactive-book-navigation-section-" + e
                  ),
                  u.appendChild(c),
                  u
                );
      ...
      const b = (function (t) {
        ...
        function o(t, e, r, n, i) {
          ...
          !(function (t, e) {
            ...
            (s.chapterTitle = s.createChapterTitle()),
            (s.menuToggleButton = s.createMenuToggleButton());
          var c = document.createElement("div");
          return (
            c.classList.add("h5p-interactive-book-status"),
            s.params.displayToTopButton && c.appendChild(s.createToTopButton()),
            s.params.displayFullScreenButton &&
              H5P.fullscreenSupported &&
              c.appendChild(s.createFullScreenButton()),
            c.appendChild(s.arrows.buttonWrapperNext),
            c.appendChild(s.arrows.buttonWrapperPrevious),
            s.params.displayMenuToggleButton &&
              ...
              t.data.toTop && (e.section = "top"),
                "next" === t.data.direction
                  ? s.parent.activeChapter + 1 < s.parent.chapters.length
                    ? (e.chapter = "h5p-interactive-book-chapter-".concat(
                        s.parent.chapters[s.parent.activeChapter + 1].instance
                          .subContentId
                      ))
                    : s.parent.hasSummary() &&
                      s.parent.activeChapter + 1 === s.parent.chapters.length &&
                      s.parent.trigger("viewSummary", e)
                  : "prev" === t.data.direction &&
                    s.parent.activeChapter > 0 &&
                    (e.chapter = "h5p-interactive-book-chapter-".concat(
                      s.parent.chapters[s.parent.activeChapter - 1].instance
                        .subContentId
                    )),
          ...
          (r = [
            {
              ...
              value: function (t) {
                ...
                var r = this.params.a11y.progress
                  .replace("@page", t)
            ...
            },
            {
              ...
              value: function (t) {
                this.progressIndicator.hiddenButRead.innerHTML =
                  this.params.a11y.progress
                    .replace("@page", t)
                    .replace("@total", this.totalChapters);
              },
            },
            {
              ...
              value: function () {
                ...
                (this.progressIndicator.current.innerHTML = t),
                  ...
                  this.parent.activeChapter <= 0
                    ? this.setButtonStatus("Previous", !0)
                    : this.setButtonStatus("Previous", !1),
                  this.parent.activeChapter + 1 >= this.totalChapters
                    ? this.setButtonStatus("Next", !0)
                    : this.setButtonStatus("Next", !1);
              },
            },
            {
              key: "addArrows",
              value: function () {
                ...
                return (
                  ...
                  e.buttonPrevious.classList.add(
                    "navigation-button",
                    "icon-previous"
                  ),
                  e.buttonPrevious.setAttribute(
                    "title",
                    this.params.l10n.previousPage
                  ),
                  (e.buttonWrapperPrevious = document.createElement("button")),
                  e.buttonWrapperPrevious.classList.add(
                    "h5p-interactive-book-status-arrow",
                    "h5p-interactive-book-status-button",
                    "previous"
                  ),
                  e.buttonWrapperPrevious.setAttribute(
                    "aria-label",
                    this.params.l10n.previousPage
                  ),
                  ...
                  e.buttonNext.classList.add("navigation-button", "icon-next"),
                  e.buttonNext.setAttribute("title", this.params.l10n.nextPage),
                  (e.buttonWrapperNext = document.createElement("button")),
                  e.buttonWrapperNext.classList.add(
                    "h5p-interactive-book-status-arrow",
                    "h5p-interactive-book-status-button",
                    "next"
                  ),
                  e.buttonWrapperNext.setAttribute(
                    "aria-label",
                    this.params.l10n.nextPage
                  ),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  r.setAttribute("aria-label", this.params.a11y.menu),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  e.appendChild(t),
                  { wrapper: e, progress: t }
                );
              },
            },
            {
              key: "createChapterTitle",
              value: function () {
                var t = document.createElement("h1");
                t.classList.add("title");
                var e = document.createElement("div");
                return (
                  e.classList.add("h5p-interactive-book-status-chapter"),
                  e.appendChild(t),
                  { wrapper: e, text: t }
                );
              },
                ...
                return (
                  ...
                  r.addEventListener("click", function () {
                    t.parent.trigger("scrollToTop"),
                      document
                        .querySelector(".h5p-interactive-book-status-menu")
                        .focus();
                  }),
                  r.appendChild(e),
                  r
            ...
            },
            {
              ...
              value: function () {
                ...
                t.classList.add("h5p-interactive-book-status-progress-number"),
                  t.setAttribute("aria-hidden", "true");
                var e = document.createElement("span");
                e.classList.add("h5p-interactive-book-status-progress-divider"),
                  (e.innerHTML = " / "),
                  e.setAttribute("aria-hidden", "true");
                var r = document.createElement("span");
                r.classList.add("h5p-interactive-book-status-progress-number"),
                  (r.innerHTML = this.totalChapters),
                  r.setAttribute("aria-hidden", "true");
                var n = document.createElement("p");
                n.classList.add("hidden-but-read");
                var a = document.createElement("p");
                a.classList.add("h5p-interactive-book-status-progress"),
                  a.appendChild(t),
                  a.appendChild(e),
                  a.appendChild(r),
                  a.appendChild(n);
            ...
            },
            {
              ...
              value: function (t, e) {
                e
                  ? (this.arrows["buttonWrapper" + t].setAttribute(
                      "disabled",
                      "disabled"
                    ),
                    this.arrows["button" + t].classList.add("disabled"))
                  : (this.arrows["buttonWrapper" + t].removeAttribute(
                      "disabled"
                    ),
                    this.arrows["button" + t].classList.remove("disabled"));
              },
            },
            {
              ...
              value: function () {
                var t = this,
                  e = function () {
                    !0 === H5P.isFullscreen
                      ? H5P.exitFullScreen()
                      : H5P.fullScreen(t.parent.mainWrapper, t.parent);
                  },
      ...
      const S = (function (t) {
        ...
        function o(t, e, r, n, i) {
          ...
          return (
            ...
            ((s = a.call(this)).parent = i),
            (s.params = t),
            (s.contentId = n),
            (s.container = s.createContainer()),
            t.coverMedium
              ? ((s.visuals = s.createVisualsElement(t.coverMedium)),
                s.visuals && s.container.appendChild(s.visuals))
              : s.container.classList.add("h5p-cover-nographics"),
            s.container.appendChild(s.createTitleElement(e)),
            t.coverDescription &&
              s.container.appendChild(
                s.createDescriptionElement(t.coverDescription)
              ),
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              ...
              value: function (t) {
                if (!t || !t.params) return null;
                var e = document.createElement("div");
                return (
                  e.classList.add("h5p-interactive-book-cover-graphics"), e
                );
              },
            },
            {
              ...
              value: function () {
                if (this.visuals && this.params.coverMedium) {
                  var t = this.params.coverMedium;
                  if (
                    ("H5P.Video" === (t.library || "").split(" ")[0] &&
                      (t.params.visuals.fit = !1),
                    H5P.newRunnable(
                      t,
                      this.contentId,
                    ...
                    "H5P.Image" === (t.library || "").split(" ")[0])
                  ) {
                    var e =
                      this.visuals.querySelector("img") ||
            ...
            },
            {
              ...
              value: function (t, e, r) {
                ...
                return (
                  n.classList.add("h5p-interactive-book-cover-image"),
                  (n.src = H5P.getPath(t, e)),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var r = document.createElement("div");
                return (
                  r.classList.add("h5p-interactive-book-cover-title"),
                  r.appendChild(e),
                  r
                );
              },
            },
            {
              ...
              value: function (t) {
                ...
                var e = document.createElement("div");
                return (
                  e.classList.add("h5p-interactive-book-cover-description"),
                  (e.innerHTML = t),
                  e
                );
              },
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  n.classList.add("h5p-interactive-book-cover-readbutton"),
                  n.appendChild(r),
                  n
                );
              },
          ...
          (n = [
            {
              ...
              value: function (e) {
                e &&
                  ...
                  (t.colorText = [
                    t.DEFAULT_COLOR_BG,
                    t.computeContrastColor(t.colorBase),
                    t.computeContrastColor(t.colorBase, t.DEFAULT_COLOR_BG),
                  ]
                    .map(function (e) {
                      return { color: e, contrast: t.colorBase.contrast(e) };
                    })
                    .reduce(
                      function (t, e) {
                        return e.contrast > t.contrast ? e : t;
                      },
                      { contrast: 0 }
                    ).color));
              },
              ...
              value: function (t) {
                var e =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : {};
                if (
                  ("string" == typeof e.opacity &&
                    /^([0-9]|[1-8][0-9]|9[0-9]|100)(\.\d+)?\s?%$/.test(
                      e.opacity
                    ) &&
                    (e.opacity = parseInt(e.opacity) / 100),
                  "number" != typeof e.opacity ||
                    e.opacity < 0 ||
                    e.opacity > 1)
                )
                  return t;
                var r = O()("#ffffff").rgb().array();
                return O().rgb(
                  t
                    .rgb()
                    .array()
                    .map(function (t, n) {
                      return e.opacity * t + (1 - e.opacity) * r[n];
                    })
                );
              },
            },
            {
              key: "isBaseColor",
              value: function (e) {
                return O()(e).hex() === t.colorBase.hex();
              },
            },
            {
              key: "computeContrastColor",
              value: function (e, r) {
                for (
                  var n,
                    a = (r = r || e).luminosity(),
                      ...
                      if (
                        (n = O().rgb(
                          e
                            ...
                            .array()
                            .map(function (t) {
                              return t * (a > 0.5 ? 1 - o : 1 + o);
                            })
                        )).contrast(r) >= t.MINIMUM_ACCEPTABLE_CONTRAST
                      )
                        return "break";
                    },
                    i = 0;
            ...
            {
              key: "getContentTypeCSS",
              value: function (e) {
                return t.COLOR_OVERRIDES[e]
                  ? t.COLOR_OVERRIDES[e].getCSS()
                  : "";
              },
            },
            {
              ...
              value: function () {
                return ":root{\n      --color-base: "
                  .concat(t.colorBase, ";\n      --color-base-5: ")
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.05 }),
                    ";\n      --color-base-10: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.1 }),
                    ";\n      --color-base-20: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.2 }),
                    ";\n      --color-base-75: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.75 }),
                    ";\n      --color-base-80: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.8 }),
                    ";\n      --color-base-85: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.85 }),
                    ";\n      --color-base-90: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.9 }),
                    ";\n      --color-base-95: "
                  )
                  .concat(
                    t.getColor(t.colorBase, { opacity: 0.95 }),
                    ";\n      --color-text: "
                  )
                  .concat(t.colorText, ";\n      --color-contrast: ")
                  .concat(
      ...
      (L.DEFAULT_COLOR_BASE = O()("#1768c4")),
        (L.DEFAULT_COLOR_BG = O()("#ffffff")),
        (L.MINIMUM_ACCEPTABLE_CONTRAST = 4.5),
        (L.colorBase = L.DEFAULT_COLOR_BASE),
        (L.colorText = L.DEFAULT_COLOR_BG);
      const F = (function (t) {
        !(function (t, e) {
          if ("function" != typeof e && null !== e)
            throw new TypeError(
        ...
        function o(t, e, r) {
          ...
          return (
            ...
            (n.bookCompleted = !1),
            (n.tempState = JSON.stringify(
              n.parent.previousState && n.parent.previousState.chapters
                ? n.parent.previousState.chapters
                : n.getChapterStats()
            )),
          ...
          (r = [
            {
              key: "setBookComplete",
              value: function (t) {
                var e = this.parent.mainWrapper
                  ? this.parent.mainWrapper[0].querySelector(
                      ".h5p-interactive-book-summary-footer"
                    )
                  : null;
                !e &&
                  this.parent.isSmallSurface() &&
                  ((e = document.createElement("div")).classList.add(
                    "h5p-interactive-book-summary-footer"
                  ),
                  e.appendChild(this.createSummaryButton()),
                  this.parent.mainWrapper.append(e)),
                  e &&
                    t &&
                    setTimeout(function () {
                ...
                if (
                  ...
                  o.length
                    ? (o[0].classList.add(
                      ...
                      o[o.length - 1].classList.add(
                        "h5p-interactive-book-summary-bottom-section"
                      ))
                    : (a.style.display = "block");
                } else
                  t === this.filterActionAll &&
                    r.classList.remove(
                      "h5p-interactive-book-summary-overview-list-only-unanswered"
                    );
                setTimeout(function () {
            ...
            },
            {
              ...
              value: function () {
                ...
                e.classList.add("h5p-interactive-book-summary-menu-button"),
                  (e.onclick = function () {
                    var e = {
                      h5pbookid: t.parent.contentId,
                      chapter: "h5p-interactive-book-chapter-summary",
                      section: "top",
                    };
                    t.parent.trigger("newChapter", e),
                      t.parent.isMenuOpen() &&
                        t.parent.isSmallSurface() &&
                        t.parent.trigger("toggleMenu");
                  });
                var r = document.createElement("span");
                r.classList.add("h5p-interactive-book-summary-icon"),
                  r.classList.add("icon-paper"),
                  r.setAttribute("aria-hidden", "true");
                var n = document.createElement("span");
                n.classList.add("h5p-interactive-book-summary-text"),
                  (n.innerHTML = this.l10n.summaryAndSubmit);
                var a = document.createElement("span");
                return (
                  a.classList.add(
                    "h5p-interactive-book-summary-menu-button-arrow"
                  ),
            ...
            },
            {
              key: "createCircle",
              value: function (t) {
                var e = L.computeContrastColor(L.colorBase, L.DEFAULT_COLOR_BG),
                ...
                return (
                  ...
                  r.setAttribute("data-start-angle", -Math.PI / 3),
                  r.setAttribute("data-thickness", 13),
                  r.setAttribute(
                    "data-empty-fill",
                    "rgba(".concat(e.rgb().array().join(", "), ", .1)")
                  ),
                  r.setAttribute(
                    "data-fill",
                    JSON.stringify({ color: e.hex() })
                  ),
                  r
                );
              },
            },
            {
              ...
              value: function (t, e, r, n) {
                ...
                c.innerHTML = t;
                var u = (100 * r) / n;
                void 0 === o && (o = r), void 0 === i && (i = n);
                var l = document.createElement("p");
                if (
                  (l.classList.add(
                    "h5p-interactive-book-summary-progressbox-bigtext"
                  ),
                  (l.innerHTML = Math.round(u) + "%"),
                  a)
                ) {
                  var p = document.createElement("span");
                  p.classList.add("absolute-value"), (p.innerHTML = r);
                  var h = document.createElement("span");
                  h.classList.add("separator"), (h.innerHTML = "/");
                  var d = document.createElement("span");
                  d.classList.add("absolute-value"),
                    (d.innerHTML = n),
                    (l.innerHTML = ""),
                    l.appendChild(p),
                    l.appendChild(h),
                ...
                f.classList.add(
                  ...
                  (f.innerHTML = e.replace("@count", o).replace("@total", i)),
                  s.appendChild(c),
                  s.appendChild(l),
                  s.appendChild(f);
                var v = document.createElement("div");
                return (
                  v.appendChild(s), v.appendChild(this.createCircle(r / n)), v
                );
              },
            },
            {
              ...
              value: function () {
                ...
                o.classList.add(
                  "h5p-interactive-book-summary-progress-container"
                ),
                  o.classList.add(
                    "h5p-interactive-book-summary-score-progress"
                  );
                var i = o.querySelector(
                  ".h5p-interactive-book-summary-progress-circle"
                );
                return (
                  i.setAttribute("data-empty-fill", "rgb(198, 220, 212)"),
                  i.setAttribute(
                    "data-fill",
                    JSON.stringify({ color: "#0e7c57" })
                  ),
                  o
                );
              },
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  t.classList.add("h5p-interactive-book-summary-book-progress"),
                  t
                );
              },
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  o.classList.add(
                    "h5p-interactive-book-summary-interactions-progress"
                  ),
                  o
                );
              },
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  e = document.createElement("div");
                if (
                  (e.classList.add("h5p-interactive-book-summary-buttons"),
                  this.checkTheAnswerIsUpdated(),
                  this.parent.isSubmitButtonEnabled &&
                    this.parent.isAnswerUpdated)
                ) {
                  var r = this.addButton(
                    "icon-paper-pencil",
                  ...
                  r.classList.add("h5p-interactive-book-summary-submit"),
                    (r.onclick = function () {
                      t.trigger("submitted"),
                        t.parent.triggerXAPIScored(
                          t.parent.getScore(),
                          t.parent.getMaxScore(),
                          "completed"
                        ),
                ...
                e.appendChild(this.createRestartButton()),
                  e.appendChild(this.createSubmittedConfirmation()),
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = document.createElement("span");
                e.classList.add("icon-chapter-done"),
                  e.classList.add("icon-check-mark"),
                  t.appendChild(e);
                var r = document.createElement("p");
                return (
                  (r.innerHTML = this.l10n.yourAnswersAreSubmittedForReview),
                  (r.tabIndex = -1),
                  r.classList.add("answers-submitted"),
                  t.appendChild(r),
                  t.appendChild(this.createRestartButton()),
                  t
                );
              },
            },
            {
              ...
              value: function (t, e) {
                var r = document.createElement("button");
                (r.type = "button"),
                  r.classList.add("h5p-interactive-book-summary-button"),
                  (r.innerHTML = e);
                var n = document.createElement("span");
                return (
                  n.classList.add(t),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                try {
                  var s = function () {
                    ...
                    if (
                      ...
                      n.behaviour.progressIndicators)
                    ) {
                      var s = document.createElement("span");
                      s.classList.add(
                        "h5p-interactive-book-summary-section-icon"
                      ),
                        s.classList.add(
                          t.taskDone
                            ? "icon-chapter-done"
                    ...
                    (c.type = "button"),
                      ...
                      (c.onclick = function () {
                        var r = {
                          h5pbookid: n.parent.contentId,
                          chapter: "h5p-interactive-book-chapter-".concat(e),
                          section: "h5p-interactive-book-section-".concat(
                    ...
                    var u =
                        t.instance.contentData &&
                        t.instance.contentData.metadata &&
                        t.instance.contentData.metadata.title,
                      l =
                        t.content &&
                        t.content.metadata &&
                        t.content.metadata.title;
                    c.innerHTML = u || l || "Untitled";
                    var p = document.createElement("div");
                    p.classList.add(
                      "h5p-interactive-book-summary-section-score"
                    ),
                      (p.innerHTML = "-"),
                      "function" == typeof t.instance.getScore &&
                        (p.innerHTML = n.l10n.scoreText
                          .replace("@score", t.instance.getScore())
                          .replace("@maxscore", t.instance.getMaxScore())),
                      t.taskDone
                        ? i.classList.add(
                ...
                if (a.length) {
                  ...
                  (u.innerHTML = this.l10n.score),
                    c.appendChild(u),
                    a.unshift(c);
                }
                return { hasUnansweredInteractions: o, sectionElements: a };
              },
            },
            {
              ...
              value: function (t) {
                ...
                n.onclick = function () {
                  var r = {
                    h5pbookid: e.parent.contentId,
                    chapter: "h5p-interactive-book-chapter-".concat(
                      t.instance.subContentId
                    ),
                    section: "top",
                  };
                ...
                if (
                  ...
                  var o = document.createElement("span"),
                    i = this.parent.getChapterStatus(t);
                  o.classList.add("icon-chapter-".concat(i.toLowerCase())),
                    n.appendChild(o);
                }
                r.appendChild(n);
                ...
                u.classList.add(
                  ...
                  t.maxTasks
                    ? (u.innerHTML = this.l10n.leftOutOfTotalCompleted
                        .replace("@left", Math.max(t.maxTasks - t.tasksLeft, 0))
                        .replace("@max", t.maxTasks))
                    : (u.innerHTML = this.l10n.noInteractions),
                  r.appendChild(u);
                var l = document.createElement("ul");
                return (
                  c.length &&
            ...
            },
            {
              ...
              value: function () {
                    ...
                    return (
                      ...
                      (s.onclick = function (e) {
                        t.setFilter(o),
                          ...
                          (a.textContent = e.currentTarget.innerHTML);
                      }),
                      i.appendChild(s),
                      i
                    );
                ...
                var a = document.createElement("span");
                (a.textContent = this.l10n.allInteractions), n.appendChild(a);
                var o = document.createElement("span");
                o.classList.add("h5p-interactive-book-summary-dropdown-icon"),
                  o.classList.add("icon-expanded"),
                  o.setAttribute("aria-hidden", "true"),
                  n.appendChild(o);
                var i = document.createElement("ul");
                (i.role = "menu"),
                  i.classList.add("h5p-interactive-book-summary-dropdown-menu");
            ...
            },
            {
              ...
              value: function () {
                ...
                (r.innerHTML = this.l10n.summaryHeader),
                  e.appendChild(r),
                  e.appendChild(this.createFilterDropdown()),
                  t.appendChild(e);
                ...
                try {
                  for (o.s(); !(a = o.n()).done; ) {
                    var i = a.value;
                    n.appendChild(this.createChapterOverview(i));
                  }
                } catch (t) {
                  o.e(t);
                } finally {
            ...
            },
            {
              ...
              value: function () {
                ...
                e.setScore(this.parent.getScore()),
                  e.appendTo(t),
                  this.wrapper.appendChild(t);
              },
            },
            {
              ...
              value: function () {
                ...
                r.classList.add(
                  ...
                  (r.innerHTML = this.l10n.noChapterInteractionText),
                  t.appendChild(e),
                  t.appendChild(r),
                  this.wrapper.appendChild(t);
              },
                  ...
                  if (
                    (this.parent.pageContent &&
                      this.parent.chapters[
                        this.parent.getChapterId(
                          this.parent.pageContent.targetPage.chapter
                        )
                      ].isSummary) ||
                    0 === this.parent.chapters.length
                  ) {
                    if (this.parent.chapters.length > 0)
                      for (var e in this.chapters)
                        this.parent.pageContent.initializeChapter(e);
                    ...
                    try {
                      for (u.s(); !(a = u.n()).done; ) {
                        ...
                        null !== i[l] &&
                          void 0 !== i[l] &&
                          (Array.isArray(i[l]) &&
                            !this.compareStates(i[l], s[l]) &&
                            c[l].taskDone &&
                            (this.parent.isAnswerUpdated = !0),
                          "object" === P(i[l]) &&
                            !Array.isArray(i[l]) &&
                            JSON.stringify(i[l]) !== JSON.stringify(s[l]) &&
                            c[l].taskDone &&
                            (this.parent.isAnswerUpdated = !0));
                      }
                    } catch (t) {
      ...
      const V = (function (t) {
        ...
        function i(t, e, r, n, a) {
          ...
          if (
            ...
            (s.sidebarIsOpen = !1),
            (s.previousState =
              r.previousState && Object.keys(r.previousState).length > 0
                ? r.previousState
                : null),
            n.hasValidChapters())
          ) {
          ...
          return (
            (s.content = s.createPageContent()),
            (s.container = document.createElement("div")),
            s.container.classList.add(
              "h5p-interactive-book-main",
              "h5p-interactive-book-navigation-hidden"
            ),
        ...
        return (
          ...
          (n = [
                ...
                t < 0 ||
                  ...
                  this.columnNodes.forEach(function (e, r) {
                    e.classList.remove("h5p-interactive-book-previous"),
                      ...
                      r === t - 1 ||
                        (r === t &&
                          e.classList.add("h5p-interactive-book-current"));
                  });
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t, e) {
                for (
                  var r = e.getElementsByClassName("h5p-column-content"), n = 0;
                  n < t.length;
                  n++
                )
                  r[n].id = "h5p-interactive-book-section-".concat(
                    t[n].instance.subContentId
                  );
              },
            },
            {
              ...
              value: function (t) {
                if (!(t < 0 || t > this.chapters.length - 1)) {
                  ...
                  if (e.isSummary) {
                    ...
                    return (
                      e.isInitialized &&
                        (e.instance.setChapters(this.getChapters(!1)),
                        (r.innerHTML = "")),
                      e.instance.addSummaryPage(H5P.jQuery(r)),
                      void (e.isInitialized = !0)
                    );
                  }
                  if (!e.isInitialized) {
                    var n = this.columnNodes[t];
                    if (
                      (e.instance.attach(H5P.jQuery(n)),
                      this.injectSectionId(e.sections, n),
                      this.behaviour.progressIndicators &&
                        !this.behaviour.progressAuto)
                    ) {
                      var a =
                        !!this.previousState &&
                        this.previousState.chapters[t].completed;
                      n.appendChild(this.createChapterReadCheckbox(a));
                    }
                    e.isInitialized = !0;
                  }
                }
            ...
            },
            {
              ...
              value: function (t, r, n) {
                var a = this,
                  o =
                    (n = _({}, n)).previousState &&
                    Object.keys(n.previousState).length > 0
                      ? n.previousState
                      : null,
                  i = e.extractFragmentsFromURL(
                    this.parent.validateFragments,
                ...
                for (
                  var c = function (e) {
                      var i = document.createElement("div"),
                        c = D(
                          ...
                          {},
                          {
                            ...
                            previousState: o ? o.chapters[e].state : {},
                          }
                        ),
                        u = H5P.newRunnable(
                          t.chapters[e],
                      ...
                      a.parent.bubbleUp(u, "resize", a.parent);
                      var l = {
                        isInitialized: !1,
                        instance: u,
                        ...
                        sections: u.getInstances().map(function (r, n) {
                          return {
                            content: t.chapters[e].params.content[n].content,
                            instance: r,
                            isTask: !1,
                          };
                        }),
                      };
                      i.classList.add("h5p-interactive-book-chapter"),
                        (i.id = "h5p-interactive-book-chapter-".concat(
                          u.subContentId
                        )),
                        (l.maxTasks = 0),
                        (l.tasksLeft = 0),
                        l.sections.forEach(function (t, r) {
                          H5P.Column.isTask(t.instance) &&
                            ...
                            l.maxTasks++,
                            l.tasksLeft++,
                            a.behaviour.progressIndicators &&
                              ((t.taskDone =
                                !!o && o.chapters[e].sections[r].taskDone),
                              t.taskDone && l.tasksLeft--));
                        }),
                        s.push(l),
                        a.columnNodes.push(i);
                    },
                    u = 0;
                  u < t.chapters.length;
                  u++
                ...
                if (this.parent.hasSummary(s)) {
                  var l = document.createElement("div"),
                    p = new F(D({}, t), this.parent, this.getChapters(!1));
                  ...
                  l.classList.add("h5p-interactive-book-chapter"),
                    (l.id = "h5p-interactive-book-chapter-summary"),
                    (h.maxTasks = h.tasksLeft),
                    s.push(h),
                    this.columnNodes.push(l);
                }
                if (i.chapter && i.h5pbookid == this.parent.contentId) {
                  var d = this.findChapterIndex(i.chapter);
                  this.parent.setActiveChapter(d);
                  var f = i.headerNumber;
                  return (
                    i.section &&
                      setTimeout(function () {
                        a.redirectSection(i.section, f),
                          a.parent.hasCover() && a.parent.cover.removeCover();
                      }, 1e3),
                    d
                  );
                }
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (
                  !this.columnNodes[
                    this.parent.getActiveChapter()
                  ].classList.contains("h5p-interactive-book-animate")
                ) {
                  this.targetPage = e;
                  var n = this.parent.getActiveChapter(),
                    a = this.parent.getChapterId(this.targetPage.chapter),
                    o = n !== a;
                  if (
                    (t || this.parent.updateChapterProgress(n, o),
                    this.preloadChapter(a),
                    a < this.columnNodes.length)
                  ) {
                    var i = this.columnNodes[n],
                      s = this.columnNodes[a];
                    if (o && !t) {
                      this.parent.setActiveChapter(a);
                      var c = n < a ? "next" : "previous";
                      s.classList.add("h5p-interactive-book-".concat(c)),
                        ...
                        setTimeout(function () {
                          "previous" === c
                            ? i.classList.add("h5p-interactive-book-next")
                            : (i.classList.remove(
                                "h5p-interactive-book-current"
                              ),
                              i.classList.add("h5p-interactive-book-previous")),
                            s.classList.remove(
                              "h5p-interactive-book-".concat(c)
                            );
                        }, 1),
                        setTimeout(function () {
                          i.classList.remove("h5p-interactive-book-next"),
                            i.classList.remove("h5p-interactive-book-previous"),
                            i.classList.remove("h5p-interactive-book-current"),
                            s.classList.add("h5p-interactive-book-current"),
                            s.classList.remove("h5p-interactive-book-animate"),
                            i.classList.remove("h5p-interactive-book-animate"),
                            r.redirectSection(
                              r.targetPage.section,
                              r.targetPage.headerNumber
                            ),
                            r.parent.trigger("resize");
                        }, 250);
                    } else
                      this.parent.cover && !this.parent.cover.hidden
                        ...
                        : this.redirectSection(
                            this.targetPage.section,
                            this.targetPage.headerNumber
                          );
                    this.parent.sideBar.redirectHandler(a);
                  }
                }
              },
            },
                  ...
                  r
                    ? n !== this.content &&
                      this.content.appendChild(
                        this.parent.statusBarFooter.wrapper
                      )
                    : n !== this.parent.$wrapper &&
                      this.parent.$wrapper.append(
                        this.parent.statusBarFooter.wrapper
                      );
                }
              },
      ...
      var at = (function (t) {
        ...
        function i(t, r) {
          ...
          var s = rt((n = o.call(this)));
          if (
            ((n.contentId = r),
            (n.previousState = a.previousState),
            t &&
              t.behaviour &&
              t.behaviour.baseColor &&
              !L.isBaseColor(t.behaviour.baseColor))
          ) {
            L.setBase(t.behaviour.baseColor);
            var c = document.createElement("style");
            c.styleSheet
              ? (c.styleSheet.cssText = L.getCSS())
              : c.appendChild(document.createTextNode(L.getCSS())),
              document.head.appendChild(c);
          }
          (n.activeChapter = 0),
            (n.newHandler = {}),
            (n.completed = !1),
            (n.params = i.sanitizeConfig(t)),
            ...
            (n.isAnswerUpdated = !0),
            void 0 !== a.isScoringEnabled || void 0 !== a.isReportingEnabled
              ? (n.isSubmitButtonEnabled =
                  a.isScoringEnabled || a.isReportingEnabled)
              : void 0 !== H5PIntegration.reportingIsEnabled &&
                (n.isSubmitButtonEnabled = H5PIntegration.reportingIsEnabled),
            ...
            (n.getAnswerGiven = function () {
              return n.chapters.reduce(function (t, e) {
                return "function" == typeof e.instance.getAnswerGiven
                  ? t && e.instance.getAnswerGiven()
                  : t;
              }, !0);
            }),
            (n.getScore = function () {
              return n.chapters.length > 0
                ? n.chapters.reduce(function (t, e) {
                    return "function" == typeof e.instance.getScore
                      ? t + e.instance.getScore()
                      : t;
                  }, 0)
            ...
            (n.getMaxScore = function () {
              return n.chapters.length > 0
                ? n.chapters.reduce(function (t, e) {
                    return "function" == typeof e.instance.getMaxScore
                      ? t + e.instance.getMaxScore()
                      : t;
                  }, 0)
            ...
            (n.showSolutions = function () {
              n.chapters.forEach(function (t) {
                "function" == typeof t.instance.toggleReadSpeaker &&
                  t.instance.toggleReadSpeaker(!0),
                  "function" == typeof t.instance.showSolutions &&
                    t.instance.showSolutions(),
                  "function" == typeof t.instance.toggleReadSpeaker &&
                    t.instance.toggleReadSpeaker(!1);
              });
            }),
            (n.resetTask = function () {
              n.hasValidChapters() &&
                (n.chapters.forEach(function (t, e) {
                  t.isInitialized &&
                    !t.isSummary &&
                    ("function" == typeof t.instance.resetTask &&
                      t.instance.resetTask(),
                ...
                n.trigger("newChapter", {
                  h5pbookid: n.contentId,
                  chapter: n.pageContent.columnNodes[0].id,
                  section: "top",
                }),
            ...
            (n.getXAPIDataFromChildren = function (t) {
              return t
                .map(function (t) {
                  if ("function" == typeof t.getXAPIData)
            ...
            (n.addQuestionToXAPI = function (t) {
              Q(
                t.getVerifiedStatementValue(["object", "definition"]),
                n.getxAPIDefinition()
              );
            }),
            ...
            (n.getCurrentState = function () {
              ...
              return {
                urlFragments: e.extractFragmentsFromURL(
                  n.validateFragments,
                  n.hashWindow
                ),
                chapters: t,
                score: n.getScore(),
                maxScore: n.getMaxScore(),
              };
            }),
            (n.getContext = function () {
              return n.cover && !n.cover.hidden
                ? {}
                : { type: "page", value: n.activeChapter + 1 };
            }),
            (n.hasCover = function () {
            ...
            (n.hasSummary = function () {
              var t =
                arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  : n.chapters;
              return (
                n.hasChaptersTasks(t) &&
                n.params.behaviour.displaySummary &&
            ...
            (n.validateFragments = function (t) {
              return (
                void 0 !== t.chapter &&
                String(t.h5pbookid) === String(s.contentId)
              );
            }),
            ...
            (n.getRatio = function () {
              return (
                n.mainWrapper.width() /
                parseFloat(n.mainWrapper.css("font-size"))
              );
            }),
            (n.setWrapperClassFromRatio = function (t) {
              ...
              e !== n.currentRatio &&
                (n.breakpoints().forEach(function (t) {
                  t.shouldAdd(e)
                    ? n.mainWrapper.addClass(t.className)
            ...
            (n.resize = function () {
              if (n.pageContent && n.hasValidChapters() && n.mainWrapper) {
                ...
                null !== e.offsetParent &&
                  (n.bubblingUpwards ||
                    n.pageContent.chapters[t].instance.trigger("resize"),
                  n.pageContent.content.style.height ===
                    "".concat(e.offsetHeight, "px") ||
                    e.classList.contains("h5p-interactive-book-animate") ||
                    ((n.pageContent.content.style.height = "".concat(
                      e.offsetHeight,
                      "px"
                    )),
            ...
            n.on("resize", n.resize, rt(n)),
            n.on("toggleMenu", function (t) {
              var e;
              n.sideBar.container.addEventListener(
                "transitionend",
                function () {
                  n.trigger("resize");
                }
              ...
              n.pageContent.toggleNavigationMenu(),
                n.statusBarHeader.menuToggleButton.setAttribute(
                  "aria-expanded",
                  n.statusBarHeader.menuToggleButton.classList.toggle(
                    "h5p-interactive-book-status-menu-active"
                  )
                    ? "true"
                    : "false"
                ),
                n.pageContent.sidebarIsOpen && r && n.sideBar.focus();
            }),
            ...
            n.on("newChapter", function (t) {
              if (
                !n.pageContent.columnNodes[
                  n.getActiveChapter()
                ].classList.contains("h5p-interactive-book-animate")
              ) {
                if (
                  ((n.newHandler = t.data),
                  (t.data.newHash = e.createFragmentsString(n.newHandler)),
                  (n.newHandler.redirectFromComponent = !0),
                  n.getChapterId(t.data.chapter) === n.activeChapter)
                )
                  if (
                    e.areFragmentsEqual(
                      t.data,
                      e.extractFragmentsFromURL(
                        n.validateFragments,
                        n.hashWindow
                      ),
                    ...
                    return void n.pageContent.changeChapter(!1, t.data);
                ...
                H5P.trigger(rt(n), "changeHash", t.data),
                  H5P.trigger(rt(n), "scrollToTop");
              }
            }),
            (n.isCurrentChapterRead = function () {
              return n.isChapterRead(
                n.chapters[n.activeChapter],
                n.params.behaviour.progressAuto
              );
            }),
            ...
            (n.setChapterRead = function () {
              var t =
                ...
                e =
                  !(arguments.length > 1 && void 0 !== arguments[1]) ||
                  arguments[1];
              n.handleChapterCompletion(t, e),
                n.sideBar.updateChapterProgressIndicator(
                  t,
                  e
                    ? "DONE"
                    : n.hasChapterStartedTasks(n.chapters[t])
                    ? "STARTED"
                    : "BLANK"
                );
            }),
            ...
            (n.getChapterStatus = function (t) {
              ...
              return (
                n.isChapterRead(t, e)
                  ? (r = "DONE")
                  : n.hasChapterStartedTasks(t) && (r = "STARTED"),
                r
              );
            }),
            (n.updateChapterProgress = function (t) {
              ...
              if (n.params.behaviour.progressIndicators) {
                ...
                "DONE" ===
                  (r = a.maxTasks
                    ? n.getChapterStatus(a)
                    : n.isChapterRead(a) && e
                    ? "DONE"
                    : "BLANK") && n.handleChapterCompletion(t),
                  n.sideBar.updateChapterProgressIndicator(t, r);
              }
            }),
              ...
              if (!0 !== r.isSummary) {
                if (!e)
                  return (
                    (r.completed = !1),
                    (n.completed = !1),
                    void n.trigger("bookCompleted", { completed: n.completed })
                  );
                r.completed ||
                  ((r.completed = !0),
                  r.instance.triggerXAPIScored(
                    r.instance.getScore(),
                    r.instance.getMaxScore(),
                    "completed"
                  )),
                  !n.completed &&
                    n.chapters
                    ...
                    ((n.completed = !0),
                    n.trigger("bookCompleted", { completed: n.completed }));
              }
            }),
            ...
            (n.getContainerWidth = function () {
              return n.pageContent && n.pageContent.container
                ? n.pageContent.container.offsetWidth
                : 0;
            }),
            (n.changeChapter = function (t) {
              n.pageContent.changeChapter(t, n.newHandler),
                n.statusBarHeader.updateStatusBar(),
                n.statusBarFooter.updateStatusBar(),
                (n.newHandler.redirectFromComponent = !1);
            }),
            ...
            H5P.on(rt(n), "respondChangeHash", function () {
              var t = e.extractFragmentsFromURL(
                s.validateFragments,
                n.hashWindow
              );
              t.h5pbookid &&
            ...
            H5P.on(rt(n), "changeHash", function (t) {
              String(t.data.h5pbookid) === String(n.contentId) &&
                (n.hashWindow.location.hash = t.data.newHash);
            }),
            H5P.externalDispatcher.on("xAPI", function (t) {
              var e =
                  ["answered", "completed", "interacted", "attempted"].indexOf(
                    t.getVerb()
                  ) > -1,
                r = s.chapters.length;
              s !== this &&
            ...
            (n.redirectChapter = function (t) {
              n.newHandler.redirectFromComponent ||
                (t.h5pbookid && String(t.h5pbookid) === String(s.contentId)
                  ...
                  : (s.newHandler = {
                      chapter: "h5p-interactive-book-chapter-".concat(
                        s.chapters[0].instance.subContentId
                      ),
                      h5pbookid: s.h5pbookid,
                    })),
                s.changeChapter(!1);
            }),
            (n.setSectionStatusByID = function (t, e) {
              n.chapters[e].sections.forEach(function (r, a) {
                var o = r.instance;
                o.subContentId !== t ||
                  r.taskDone ||
                  ((r.taskDone = !o.getAnswerGiven || o.getAnswerGiven()),
                  n.sideBar.setSectionMarker(e, a),
                  r.taskDone && (n.chapters[e].tasksLeft -= 1),
                  n.updateChapterProgress(e));
              });
            }),
            (n.addHashListener = function (t) {
              t.addEventListener("hashchange", function (t) {
                H5P.trigger(rt(n), "respondChangeHash", t);
              }),
                (n.hashWindow = t);
            });
          try {
          ...
          (n.displayCover = function (t) {
            ...
            (n.attach = function (t) {
              ...
              e && n.pageContent.container.insertBefore(n.sideBar.container, e),
                ...
                (n.$wrapper = t),
                n.params.behaviour.defaultTableOfContents &&
                  !n.isSmallSurface() &&
                  n.trigger("toggleMenu", { shouldNotFocusNav: !0 }),
                n.pageContent.updateFooter();
            }),
            ...
            (n.hideAllElements = function (t) {
              ...
              t
                ? e.forEach(function (t) {
                    t.classList.add("h5p-content-hidden"),
                      t.classList.add("h5p-interactive-book-cover-present");
                  })
                : e.forEach(function (t) {
                    t.classList.remove("h5p-content-hidden"),
                      t.classList.remove("h5p-interactive-book-cover-present");
                  });
            }),
            n.params.showCoverPage &&
              (n.cover = new S(
                n.params.bookCover,
                a.metadata.title,
                n.l10n.read,
          ...
          var u = Y(Y({}, a), {}, { parent: rt(n) });
          return (
            (n.pageContent = new V(n.params, r, u, rt(n), {
              l10n: { markAsFinished: n.l10n.markAsFinished },
              behaviour: n.params.behaviour,
            })),
            (n.chapters = n.pageContent.getChapters()),
            (n.sideBar = new l(n.params, r, a.metadata.title, rt(n))),
            n.chapters.forEach(function (t, e) {
              n.setChapterRead(e, t.completed);
            }),
            (n.statusBarHeader = new b(
              r,
              n.chapters.length,
              rt(n),
              {
                ...
                a11y: n.params.a11y,
                behaviour: n.params.behaviour,
                displayFullScreenButton: !0,
                displayMenuToggleButton: !0,
              },
              "h5p-interactive-book-status-header"
            )),
            (n.statusBarFooter = new b(
              r,
              n.chapters.length,
              rt(n),
              {
              ...
              ? (n.hideAllElements(!0),
                n.on("coverRemoved", function () {
                  n.hideAllElements(!1),
                    ...
                    n.statusBarHeader.progressBar.progress.focus();
                }))
              : n.setActivityStarted(),
            n.hasValidChapters() &&
              (n.statusBarHeader.updateStatusBar(),
        ...
        return (
          ...
          (a = [
            {
              ...
              value: function (t) {
                var e = t.read,
                  ...
                  n = t.displayTOC,
                  a =
                    void 0 === n ? "Display &#039;Table of contents&#039;" : n,
                  o = t.hideTOC,
                  i = void 0 === o ? "Hide &#039;Table of contents&#039;" : o,
                  s = t.nextPage,
                  c = void 0 === s ? "Next page" : s,
                  u = t.previousPage,
                  l = void 0 === u ? "Previous page" : u,
                  p = t.chapterCompleted,
                  h = void 0 === p ? "Page completed!" : p,
                  d = t.partCompleted,
                  f = void 0 === d ? "@pages of @total completed" : d,
                  v = t.incompleteChapter,
                  m = void 0 === v ? "Incomplete page" : v,
                  b = t.navigateToTop,
                  g = void 0 === b ? "Navigate to the top" : b,
                  y = t.markAsFinished,
                  k = void 0 === y ? "I have finished this page" : y,
                  w = t.fullscreen,
                  C = void 0 === w ? "Fullscreen" : w,
                  S = t.exitFullscreen,
                  x = void 0 === S ? "Exit fullscreen" : S,
                  O = t.bookProgressSubtext,
                  E = void 0 === O ? "@count of @total pages" : O,
                  L = t.interactionsProgressSubtext,
                  P = void 0 === L ? "@count of @total interactions" : L,
                  A = t.submitReport,
                  T = void 0 === A ? "Submit Report" : A,
                  j = t.restartLabel,
                  I = void 0 === j ? "Restart" : j,
                  M = t.summaryHeader,
                  B = void 0 === M ? "Summary" : M,
                  F = t.allInteractions,
                  R = void 0 === F ? "All interactions" : F,
                  N = t.unansweredInteractions,
                  D = void 0 === N ? "Unanswered interactions" : N,
                  H = t.scoreText,
                  _ = void 0 === H ? "@score / @maxscore" : H,
                  z = t.leftOutOfTotalCompleted,
                  q = void 0 === z ? "@left of @max interactinos completed" : z,
                  U = t.noInteractions,
                  W = void 0 === U ? "No interactions" : U,
                  V = t.score,
                  $ = void 0 === V ? "Score" : V,
                  J = t.summaryAndSubmit,
                  Y = void 0 === J ? "Summary & submit" : J,
                  K = t.noChapterInteractionBoldText,
                  Q =
                    void 0 === K
                      ? "You have not interacted with any pages."
                      : K,
                  Z = t.noChapterInteractionText,
                  tt =
                    void 0 === Z
                      ? "You have to interact with at least one page before you can see the summary."
                      : Z,
                  ...
                  rt =
                    void 0 === et
                      ...
                      : et,
                  nt = t.bookProgress,
                  at = void 0 === nt ? "Book progress" : nt,
                  ot = t.interactionsProgress,
                  it = void 0 === ot ? "Interactions progress" : ot,
                ...
                return (
                  (ut.chapters = ut.chapters
                    .map(function (t) {
                      return (
                        (t.params.content = t.params.content.filter(function (
                          t
                        ) {
                          return t.content;
                        })),
                  ...
                  (ut.l10n = {
                    ...
                    fullscreen: C,
                    exitFullscreen: x,
                    bookProgressSubtext: E,
                    interactionsProgressSubtext: P,
                    submitReport: T,
                    restartLabel: I,
                    summaryHeader: B,
                    allInteractions: R,
                    unansweredInteractions: D,
                    scoreText: _,
                    leftOutOfTotalCompleted: q,
                    noInteractions: W,
                    score: $,
                    summaryAndSubmit: Y,
          ...
          (n = null) && Z(r.prototype, n),
          a && Z(r, a),
          Object.defineProperty(r, "prototype", { writable: !1 }),
          i
        );
      })();
      (H5P = H5P || {}), (H5P.InteractiveBook = at);
    })();
})();
